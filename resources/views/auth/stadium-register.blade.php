<x-guest-layout>
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                <x-label for="stadium_address" value="{{ __('Stadium Address') }}" />
                <x-input id="stadium_address" class="block w-full mt-1" type="text" name="stadium_address" :value="old('stadium_address')" required autocomplete="stadium_address" />
            </div>
